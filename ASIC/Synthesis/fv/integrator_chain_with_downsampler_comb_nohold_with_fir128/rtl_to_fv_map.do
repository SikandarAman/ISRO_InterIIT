...
# Generated on: Sun Dec 07 04:49:00 IST 2025 (Sat Dec 06 23:19:00 UTC 2025)
...
set logfile fv/integrator_chain_with_downsampler_comb_nohold_with_fir128/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/integrator_chain_with_downsampler_comb_nohold_with_fir128 -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/cad/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/cad/GENUS211/tools.lnx86"
set env(CW_DIR) "/cad/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/cad/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /cad/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/cad/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/cad/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/cad/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/cad/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /cad/FOUNDRY/digital/180nm/dig/lib -library -both
read_library -liberty -both \
    /cad/FOUNDRY/digital/180nm/dig/lib/typical.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  decim_filter.v
elaborate_design -golden -root {integrator_chain_with_downsampler_comb_nohold_with_fir128} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/integrator_chain_with_downsampler_comb_nohold_with_fir128/fv_map.v.gz
elaborate_design -revised -root {integrator_chain_with_downsampler_comb_nohold_with_fir128}
...
#add_name_alias fv/integrator_chain_with_downsampler_comb_nohold_with_fir128/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.integrator_chain_with_downsampler_comb_nohold_with_fir128.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.integrator_chain_with_downsampler_comb_nohold_with_fir128.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.integrator_chain_with_downsampler_comb_nohold_with_fir128.rtl.fv_map.rpt
